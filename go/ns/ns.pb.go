...
type NetworkServerServiceClient interface {
	...
	StreamGlobalFrameLogsForGateway(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (NetworkServerService_StreamGlobalFrameLogsForGatewayClient, error)
	...
	StreamGlobalFrameLogsForDevice(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (NetworkServerService_StreamGlobalFrameLogsForDeviceClient, error)
	// ClearDeviceDevNonce clear device devnonce from activation records.
	ClearDeviceDevNonce(ctx context.Context, in *ClearDeviceDevNonceRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *networkServerServiceClient) StreamGlobalFrameLogsForGateway(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (NetworkServerService_StreamGlobalFrameLogsForGatewayClient, error) {
...
func (c *networkServerServiceClient) StreamGlobalFrameLogsForDevice(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (NetworkServerService_StreamGlobalFrameLogsForDeviceClient, error) {
...
func (c *networkServerServiceClient) ClearDeviceDevNonce(ctx context.Context, in *ClearDeviceDevNonceRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type NetworkServerServiceServer interface {
	...
	// StreamGlobalFrameLogsForGateway returns a stream of frames seen by the gateways.
	// logging of uplink and downlink frames for gateways to a Redis Stream for external logging and monitoring purposes.
	StreamGlobalFrameLogsForGateway(*empty.Empty, NetworkServerService_StreamGlobalFrameLogsForGatewayServer) error
	// StreamGlobalFrameLogsForDevice returns a stream of frames seen by the devices.
	// logging of uplink and downlink frames for devices to a Redis Stream for external logging and monitoring purposes.
	StreamGlobalFrameLogsForDevice(*empty.Empty, NetworkServerService_StreamGlobalFrameLogsForDeviceServer) error
	// ClearDeviceDevNonce clear device devnonce from activation records.
	ClearDeviceDevNonce(context.Context, *ClearDeviceDevNonceRequest) (*empty.Empty, error)
}
...
func (*UnimplementedNetworkServerServiceServer) StreamGlobalFrameLogsForGateway(req *empty.Empty, srv NetworkServerService_StreamGlobalFrameLogsForGatewayServer) error {
	return status.Errorf(codes.Unimplemented, "method StreamGlobalFrameLogsForGateway not implemented")
}
func (*UnimplementedNetworkServerServiceServer) StreamGlobalFrameLogsForDevice(req *empty.Empty, srv NetworkServerService_StreamGlobalFrameLogsForDeviceServer) error {
	return status.Errorf(codes.Unimplemented, "method StreamGlobalFrameLogsForDevice not implemented")
}
func (*UnimplementedNetworkServerServiceServer) ClearDeviceDevNonce(ctx context.Context, req *ClearDeviceDevNonceRequest) (*empty.Empty, error) {
