...
type GetDeviceResponse struct {
	...
	DeviceMode           string   `protobuf:"bytes,4,opt,name=DeviceMode,proto3" json:"DeviceMode,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type ExtraSessionParameter struct {
	// RXDelay
	RXDelay uint32 `protobuf:"varint,1,opt,name=RXDelay,proto3" json:"RXDelay,omitempty"`
	// RX1 data-rate offset
	RX1DROffset uint32 `protobuf:"varint,2,opt,name=RX1DROffset,proto3" json:"RX1DROffset,omitempty"`
	// RX2 data-rate
	RX2DR uint32 `protobuf:"varint,3,opt,name=RX2DR,proto3" json:"RX2DR,omitempty"`
	// RX2 frequency
	RX2Frequency uint32 `protobuf:"varint,4,opt,name=RX2Frequency,proto3" json:"RX2Frequency,omitempty"`
	// tx power index
	TXPowerIndex int32 `protobuf:"varint,5,opt,name=TXPowerIndex,proto3" json:"TXPowerIndex,omitempty"`
	// Extra Uplink channels
	ExtraUplinkChannels []*ExtraChannels `protobuf:"bytes,6,rep,name=extra_uplink_channels,json=extraUplinkChannels,proto3" json:"extra_uplink_channels,omitempty"`
	// Last Device Status Requested time-stamp.
	LastDevStatusRequested *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=last_dev_status_requested,json=lastDevStatusRequested,proto3" json:"last_dev_status_requested,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}               `json:"-"`
	XXX_unrecognized       []byte                 `json:"-"`
	XXX_sizecache          int32                  `json:"-"`
}

func (m *ExtraSessionParameter) Reset()         { *m = ExtraSessionParameter{} }
func (m *ExtraSessionParameter) String() string { return proto.CompactTextString(m) }
func (*ExtraSessionParameter) ProtoMessage()    {}
func (*ExtraSessionParameter) Descriptor() ([]byte, []int) {
	return fileDescriptor_412103b9b2fd26a9, []int{25}
}

func (m *ExtraSessionParameter) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ExtraSessionParameter.Unmarshal(m, b)
}
func (m *ExtraSessionParameter) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ExtraSessionParameter.Marshal(b, m, deterministic)
}
func (m *ExtraSessionParameter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExtraSessionParameter.Merge(m, src)
}
func (m *ExtraSessionParameter) XXX_Size() int {
	return xxx_messageInfo_ExtraSessionParameter.Size(m)
}
func (m *ExtraSessionParameter) XXX_DiscardUnknown() {
	xxx_messageInfo_ExtraSessionParameter.DiscardUnknown(m)
}

var xxx_messageInfo_ExtraSessionParameter proto.InternalMessageInfo

func (m *ExtraSessionParameter) GetRXDelay() uint32 {
	if m != nil {
		return m.RXDelay
	}
	return 0
...
func (m *ExtraSessionParameter) GetRX1DROffset() uint32 {
	if m != nil {
...
func (m *ExtraSessionParameter) GetRX2DR() uint32 {
	if m != nil {
		return m.RX2DR
	}
	return 0
...
func (m *ExtraSessionParameter) GetRX2Frequency() uint32 {
	if m != nil {
...
func (m *ExtraSessionParameter) GetTXPowerIndex() int32 {
	if m != nil {
...
func (m *ExtraSessionParameter) GetExtraUplinkChannels() []*ExtraChannels {
	if m != nil {
...
func (m *ExtraSessionParameter) GetLastDevStatusRequested() *timestamppb.Timestamp {
	if m != nil {
		return m.LastDevStatusRequested
	}
	return nil
}
...
type GetDeviceActivationResponse struct {
	...
	ExtraSessionParameter *ExtraSessionParameter `protobuf:"bytes,2,opt,name=extra_session_parameter,json=extraSessionParameter,proto3" json:"extra_session_parameter,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}               `json:"-"`
	XXX_unrecognized      []byte                 `json:"-"`
	XXX_sizecache         int32                  `json:"-"`
}
...
func (m *GetDeviceActivationResponse) GetExtraSessionParameter() *ExtraSessionParameter {
	if m != nil {
		return m.ExtraSessionParameter
	}
	return nil
}
...
type StreamFrameLogsForGatewayResponse struct {
	...
	//	*StreamFrameLogsForGatewayResponse_StatsFrame
...
type StreamFrameLogsForGatewayResponse_StatsFrame struct {
...
func (*StreamFrameLogsForGatewayResponse_StatsFrame) isStreamFrameLogsForGatewayResponse_Frame() {}
...
func (m *StreamFrameLogsForGatewayResponse) GetStatsFrame() *GatewayStatsFrameLog {
	if x, ok := m.GetFrame().(*StreamFrameLogsForGatewayResponse_StatsFrame); ok {
		return x.StatsFrame
	}
	return nil
}
...
func (*StreamFrameLogsForGatewayResponse) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*StreamFrameLogsForGatewayResponse_StatsFrame)(nil),
	}
}

type StreamGlobalFrameLogsForGatewayResponse struct {
	// Types that are valid to be assigned to Frame:
	//	*StreamGlobalFrameLogsForGatewayResponse_UplinkFrameSet
	//	*StreamGlobalFrameLogsForGatewayResponse_DownlinkFrame
	//	*StreamGlobalFrameLogsForGatewayResponse_StatsFrame
	Frame isStreamGlobalFrameLogsForGatewayResponse_Frame `protobuf_oneof:"frame"`
	// MAC address of the gateway.
	GatewayEui           []byte   `protobuf:"bytes,4,opt,name=gateway_eui,json=gatewayEui,proto3" json:"gateway_eui,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *StreamGlobalFrameLogsForGatewayResponse) Reset() {
	*m = StreamGlobalFrameLogsForGatewayResponse{}
}
func (m *StreamGlobalFrameLogsForGatewayResponse) String() string { return proto.CompactTextString(m) }
func (*StreamGlobalFrameLogsForGatewayResponse) ProtoMessage()    {}
func (*StreamGlobalFrameLogsForGatewayResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_412103b9b2fd26a9, []int{58}
}

func (m *StreamGlobalFrameLogsForGatewayResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_StreamGlobalFrameLogsForGatewayResponse.Unmarshal(m, b)
}
func (m *StreamGlobalFrameLogsForGatewayResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_StreamGlobalFrameLogsForGatewayResponse.Marshal(b, m, deterministic)
}
func (m *StreamGlobalFrameLogsForGatewayResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StreamGlobalFrameLogsForGatewayResponse.Merge(m, src)
}
func (m *StreamGlobalFrameLogsForGatewayResponse) XXX_Size() int {
	return xxx_messageInfo_StreamGlobalFrameLogsForGatewayResponse.Size(m)
}
func (m *StreamGlobalFrameLogsForGatewayResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_StreamGlobalFrameLogsForGatewayResponse.DiscardUnknown(m)
}

var xxx_messageInfo_StreamGlobalFrameLogsForGatewayResponse proto.InternalMessageInfo

type isStreamGlobalFrameLogsForGatewayResponse_Frame interface {
	isStreamGlobalFrameLogsForGatewayResponse_Frame()
}

type StreamGlobalFrameLogsForGatewayResponse_UplinkFrameSet struct {
	UplinkFrameSet *UplinkFrameLog `protobuf:"bytes,1,opt,name=uplink_frame_set,json=uplinkFrameSet,proto3,oneof"`
}

type StreamGlobalFrameLogsForGatewayResponse_DownlinkFrame struct {
	DownlinkFrame *DownlinkFrameLog `protobuf:"bytes,2,opt,name=downlink_frame,json=downlinkFrame,proto3,oneof"`
}

type StreamGlobalFrameLogsForGatewayResponse_StatsFrame struct {
	StatsFrame *GatewayStatsFrameLog `protobuf:"bytes,3,opt,name=stats_frame,json=statsFrame,proto3,oneof"`
}

func (*StreamGlobalFrameLogsForGatewayResponse_UplinkFrameSet) isStreamGlobalFrameLogsForGatewayResponse_Frame() {
}

func (*StreamGlobalFrameLogsForGatewayResponse_DownlinkFrame) isStreamGlobalFrameLogsForGatewayResponse_Frame() {
}

func (*StreamGlobalFrameLogsForGatewayResponse_StatsFrame) isStreamGlobalFrameLogsForGatewayResponse_Frame() {
}

func (m *StreamGlobalFrameLogsForGatewayResponse) GetFrame() isStreamGlobalFrameLogsForGatewayResponse_Frame {
	if m != nil {
		return m.Frame
	}
	return nil
...
func (m *StreamGlobalFrameLogsForGatewayResponse) GetUplinkFrameSet() *UplinkFrameLog {
	if x, ok := m.GetFrame().(*StreamGlobalFrameLogsForGatewayResponse_UplinkFrameSet); ok {
		return x.UplinkFrameSet
	}
	return nil
}

func (m *StreamGlobalFrameLogsForGatewayResponse) GetDownlinkFrame() *DownlinkFrameLog {
	if x, ok := m.GetFrame().(*StreamGlobalFrameLogsForGatewayResponse_DownlinkFrame); ok {
		return x.DownlinkFrame
	}
	return nil
}

func (m *StreamGlobalFrameLogsForGatewayResponse) GetStatsFrame() *GatewayStatsFrameLog {
	if x, ok := m.GetFrame().(*StreamGlobalFrameLogsForGatewayResponse_StatsFrame); ok {
		return x.StatsFrame
	}
	return nil
}

func (m *StreamGlobalFrameLogsForGatewayResponse) GetGatewayEui() []byte {
	if m != nil {
		return m.GatewayEui
	}
	return nil
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*StreamGlobalFrameLogsForGatewayResponse) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*StreamGlobalFrameLogsForGatewayResponse_UplinkFrameSet)(nil),
		(*StreamGlobalFrameLogsForGatewayResponse_DownlinkFrame)(nil),
		(*StreamGlobalFrameLogsForGatewayResponse_StatsFrame)(nil),
	}
}
...
type StreamGlobalFrameLogsForDeviceResponse struct {
	// Types that are valid to be assigned to Frame:
	//	*StreamGlobalFrameLogsForDeviceResponse_UplinkFrameSet
	//	*StreamGlobalFrameLogsForDeviceResponse_DownlinkFrame
	Frame isStreamGlobalFrameLogsForDeviceResponse_Frame `protobuf_oneof:"frame"`
	// DevEUI of the device.
...
func (m *StreamGlobalFrameLogsForDeviceResponse) Reset() {
	*m = StreamGlobalFrameLogsForDeviceResponse{}
}
func (m *StreamGlobalFrameLogsForDeviceResponse) String() string { return proto.CompactTextString(m) }
func (*StreamGlobalFrameLogsForDeviceResponse) ProtoMessage()    {}
func (*StreamGlobalFrameLogsForDeviceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_412103b9b2fd26a9, []int{61}
}

func (m *StreamGlobalFrameLogsForDeviceResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_StreamGlobalFrameLogsForDeviceResponse.Unmarshal(m, b)
}
func (m *StreamGlobalFrameLogsForDeviceResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_StreamGlobalFrameLogsForDeviceResponse.Marshal(b, m, deterministic)
}
func (m *StreamGlobalFrameLogsForDeviceResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StreamGlobalFrameLogsForDeviceResponse.Merge(m, src)
}
func (m *StreamGlobalFrameLogsForDeviceResponse) XXX_Size() int {
	return xxx_messageInfo_StreamGlobalFrameLogsForDeviceResponse.Size(m)
}
func (m *StreamGlobalFrameLogsForDeviceResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_StreamGlobalFrameLogsForDeviceResponse.DiscardUnknown(m)
}

var xxx_messageInfo_StreamGlobalFrameLogsForDeviceResponse proto.InternalMessageInfo

type isStreamGlobalFrameLogsForDeviceResponse_Frame interface {
	isStreamGlobalFrameLogsForDeviceResponse_Frame()
}

type StreamGlobalFrameLogsForDeviceResponse_UplinkFrameSet struct {
	UplinkFrameSet *UplinkFrameLog `protobuf:"bytes,1,opt,name=uplink_frame_set,json=uplinkFrameSet,proto3,oneof"`
}

type StreamGlobalFrameLogsForDeviceResponse_DownlinkFrame struct {
	DownlinkFrame *DownlinkFrameLog `protobuf:"bytes,2,opt,name=downlink_frame,json=downlinkFrame,proto3,oneof"`
}

func (*StreamGlobalFrameLogsForDeviceResponse_UplinkFrameSet) isStreamGlobalFrameLogsForDeviceResponse_Frame() {
}

func (*StreamGlobalFrameLogsForDeviceResponse_DownlinkFrame) isStreamGlobalFrameLogsForDeviceResponse_Frame() {
}

func (m *StreamGlobalFrameLogsForDeviceResponse) GetFrame() isStreamGlobalFrameLogsForDeviceResponse_Frame {
	if m != nil {
		return m.Frame
	}
	return nil
...
func (m *StreamGlobalFrameLogsForDeviceResponse) GetUplinkFrameSet() *UplinkFrameLog {
	if x, ok := m.GetFrame().(*StreamGlobalFrameLogsForDeviceResponse_UplinkFrameSet); ok {
		return x.UplinkFrameSet
	}
	return nil
}

func (m *StreamGlobalFrameLogsForDeviceResponse) GetDownlinkFrame() *DownlinkFrameLog {
	if x, ok := m.GetFrame().(*StreamGlobalFrameLogsForDeviceResponse_DownlinkFrame); ok {
		return x.DownlinkFrame
	}
	return nil
}

func (m *StreamGlobalFrameLogsForDeviceResponse) GetDevEui() []byte {
	if m != nil {
		return m.DevEui
	}
	return nil
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*StreamGlobalFrameLogsForDeviceResponse) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*StreamGlobalFrameLogsForDeviceResponse_UplinkFrameSet)(nil),
		(*StreamGlobalFrameLogsForDeviceResponse_DownlinkFrame)(nil),
	}
}
...
type ClearDeviceDevNonceRequest struct {
	// Device EUI (8 bytes).
	DevEui               []byte   `protobuf:"bytes,1,opt,name=dev_eui,json=devEui,proto3" json:"dev_eui,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
...
func (m *ClearDeviceDevNonceRequest) Reset()         { *m = ClearDeviceDevNonceRequest{} }
func (m *ClearDeviceDevNonceRequest) String() string { return proto.CompactTextString(m) }
func (*ClearDeviceDevNonceRequest) ProtoMessage()    {}
func (*ClearDeviceDevNonceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_412103b9b2fd26a9, []int{87}
}

func (m *ClearDeviceDevNonceRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ClearDeviceDevNonceRequest.Unmarshal(m, b)
}
func (m *ClearDeviceDevNonceRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ClearDeviceDevNonceRequest.Marshal(b, m, deterministic)
}
func (m *ClearDeviceDevNonceRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ClearDeviceDevNonceRequest.Merge(m, src)
}
func (m *ClearDeviceDevNonceRequest) XXX_Size() int {
	return xxx_messageInfo_ClearDeviceDevNonceRequest.Size(m)
}
func (m *ClearDeviceDevNonceRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ClearDeviceDevNonceRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ClearDeviceDevNonceRequest proto.InternalMessageInfo

func (m *ClearDeviceDevNonceRequest) GetDevEui() []byte {
	if m != nil {
		return m.DevEui
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ExtraSessionParameter)(nil), "ns.ExtraSessionParameter")
	...
	proto.RegisterType((*GatewayStatsFrameLog)(nil), "ns.GatewayStatsFrameLog")
	proto.RegisterMapType((map[string]string)(nil), "ns.GatewayStatsFrameLog.MetaDataEntry")
	...
	proto.RegisterType((*StreamGlobalFrameLogsForGatewayResponse)(nil), "ns.StreamGlobalFrameLogsForGatewayResponse")
	...
	proto.RegisterType((*StreamGlobalFrameLogsForDeviceResponse)(nil), "ns.StreamGlobalFrameLogsForDeviceResponse")
	...
	proto.RegisterType((*ClearDeviceDevNonceRequest)(nil), "ns.ClearDeviceDevNonceRequest")
}
...
var fileDescriptor_412103b9b2fd26a9 = []byte{
	...
	,
}
...
type NetworkServerServiceClient interface {
	...
	StreamGlobalFrameLogsForGateway(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (NetworkServerService_StreamGlobalFrameLogsForGatewayClient, error)
	...
	StreamGlobalFrameLogsForDevice(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (NetworkServerService_StreamGlobalFrameLogsForDeviceClient, error)
	// ClearDeviceDevNonce clear device devnonce from activation records.
	ClearDeviceDevNonce(ctx context.Context, in *ClearDeviceDevNonceRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *networkServerServiceClient) StreamGlobalFrameLogsForGateway(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (NetworkServerService_StreamGlobalFrameLogsForGatewayClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NetworkServerService_serviceDesc.Streams[2], "/ns.NetworkServerService/StreamGlobalFrameLogsForGateway", opts...)
	if err != nil {
		return nil, err
	}
	x := &networkServerServiceStreamGlobalFrameLogsForGatewayClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type NetworkServerService_StreamGlobalFrameLogsForGatewayClient interface {
	Recv() (*StreamGlobalFrameLogsForGatewayResponse, error)
	grpc.ClientStream
}

type networkServerServiceStreamGlobalFrameLogsForGatewayClient struct {
	grpc.ClientStream
}

func (x *networkServerServiceStreamGlobalFrameLogsForGatewayClient) Recv() (*StreamGlobalFrameLogsForGatewayResponse, error) {
	m := new(StreamGlobalFrameLogsForGatewayResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *networkServerServiceClient) StreamGlobalFrameLogsForDevice(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (NetworkServerService_StreamGlobalFrameLogsForDeviceClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NetworkServerService_serviceDesc.Streams[3], "/ns.NetworkServerService/StreamGlobalFrameLogsForDevice", opts...)
	if err != nil {
		return nil, err
	}
	x := &networkServerServiceStreamGlobalFrameLogsForDeviceClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type NetworkServerService_StreamGlobalFrameLogsForDeviceClient interface {
	Recv() (*StreamGlobalFrameLogsForDeviceResponse, error)
	grpc.ClientStream
}

type networkServerServiceStreamGlobalFrameLogsForDeviceClient struct {
	grpc.ClientStream
}

func (x *networkServerServiceStreamGlobalFrameLogsForDeviceClient) Recv() (*StreamGlobalFrameLogsForDeviceResponse, error) {
	m := new(StreamGlobalFrameLogsForDeviceResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *networkServerServiceClient) ClearDeviceDevNonce(ctx context.Context, in *ClearDeviceDevNonceRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/ns.NetworkServerService/ClearDeviceDevNonce", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NetworkServerServiceServer interface {
	...
	// StreamGlobalFrameLogsForGateway returns a stream of frames seen by the gateways.
	// logging of uplink and downlink frames for gateways to a Redis Stream for external logging and monitoring purposes.
	StreamGlobalFrameLogsForGateway(*emptypb.Empty, NetworkServerService_StreamGlobalFrameLogsForGatewayServer) error
	// StreamGlobalFrameLogsForDevice returns a stream of frames seen by the devices.
	// logging of uplink and downlink frames for devices to a Redis Stream for external logging and monitoring purposes.
	StreamGlobalFrameLogsForDevice(*emptypb.Empty, NetworkServerService_StreamGlobalFrameLogsForDeviceServer) error
	// ClearDeviceDevNonce clear device devnonce from activation records.
	ClearDeviceDevNonce(context.Context, *ClearDeviceDevNonceRequest) (*emptypb.Empty, error)
}
...
func (*UnimplementedNetworkServerServiceServer) StreamGlobalFrameLogsForGateway(req *emptypb.Empty, srv NetworkServerService_StreamGlobalFrameLogsForGatewayServer) error {
	return status.Errorf(codes.Unimplemented, "method StreamGlobalFrameLogsForGateway not implemented")
}
func (*UnimplementedNetworkServerServiceServer) StreamGlobalFrameLogsForDevice(req *emptypb.Empty, srv NetworkServerService_StreamGlobalFrameLogsForDeviceServer) error {
	return status.Errorf(codes.Unimplemented, "method StreamGlobalFrameLogsForDevice not implemented")
}
func (*UnimplementedNetworkServerServiceServer) ClearDeviceDevNonce(ctx context.Context, req *ClearDeviceDevNonceRequest) (*emptypb.Empty, error) {
...
func _NetworkServerService_StreamGlobalFrameLogsForGateway_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(emptypb.Empty)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(NetworkServerServiceServer).StreamGlobalFrameLogsForGateway(m, &networkServerServiceStreamGlobalFrameLogsForGatewayServer{stream})
}

type NetworkServerService_StreamGlobalFrameLogsForGatewayServer interface {
	Send(*StreamGlobalFrameLogsForGatewayResponse) error
	grpc.ServerStream
}

type networkServerServiceStreamGlobalFrameLogsForGatewayServer struct {
	grpc.ServerStream
}

func (x *networkServerServiceStreamGlobalFrameLogsForGatewayServer) Send(m *StreamGlobalFrameLogsForGatewayResponse) error {
	return x.ServerStream.SendMsg(m)
}

func _NetworkServerService_StreamGlobalFrameLogsForDevice_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(emptypb.Empty)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(NetworkServerServiceServer).StreamGlobalFrameLogsForDevice(m, &networkServerServiceStreamGlobalFrameLogsForDeviceServer{stream})
}

type NetworkServerService_StreamGlobalFrameLogsForDeviceServer interface {
	Send(*StreamGlobalFrameLogsForDeviceResponse) error
	grpc.ServerStream
}

type networkServerServiceStreamGlobalFrameLogsForDeviceServer struct {
	grpc.ServerStream
}

func (x *networkServerServiceStreamGlobalFrameLogsForDeviceServer) Send(m *StreamGlobalFrameLogsForDeviceResponse) error {
	return x.ServerStream.SendMsg(m)
}

func _NetworkServerService_ClearDeviceDevNonce_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClearDeviceDevNonceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NetworkServerServiceServer).ClearDeviceDevNonce(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ns.NetworkServerService/ClearDeviceDevNonce",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NetworkServerServiceServer).ClearDeviceDevNonce(ctx, req.(*ClearDeviceDevNonceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _NetworkServerService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NetworkServerService_ClearDeviceDevNonce_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "StreamGlobalFrameLogsForGateway",
			Handler:       _NetworkServerService_StreamGlobalFrameLogsForGateway_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "StreamGlobalFrameLogsForDevice",
			Handler:       _NetworkServerService_StreamGlobalFrameLogsForDevice_Handler,
			ServerStreams: true,
		},
	},
