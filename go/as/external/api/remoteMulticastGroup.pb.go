...
type RemoteMulticastGroupType int32

const (
	// Class-C.
	RemoteMulticastGroupType_CLASS_C RemoteMulticastGroupType = 0
	// Class-B.
	RemoteMulticastGroupType_CLASS_B RemoteMulticastGroupType = 1
)

var RemoteMulticastGroupType_name = map[int32]string{
	0: "CLASS_C",
	1: "CLASS_B",
}

var RemoteMulticastGroupType_value = map[string]int32{
	"CLASS_C": 0,
	"CLASS_B": 1,
}

func (x RemoteMulticastGroupType) String() string {
	return proto.EnumName(RemoteMulticastGroupType_name, int32(x))
}

func (RemoteMulticastGroupType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_a7745b072e8a8e4e, []int{0}
}

type RemoteMulticastDeploymentDeviceState int32

const (
	// Pending.
	RemoteMulticastDeploymentDeviceState_PENDING RemoteMulticastDeploymentDeviceState = 0
	// Success.
	RemoteMulticastDeploymentDeviceState_SUCCESS RemoteMulticastDeploymentDeviceState = 1
	// Error.
	RemoteMulticastDeploymentDeviceState_ERROR RemoteMulticastDeploymentDeviceState = 2
)

var RemoteMulticastDeploymentDeviceState_name = map[int32]string{
	0: "PENDING",
	1: "SUCCESS",
	2: "ERROR",
}

var RemoteMulticastDeploymentDeviceState_value = map[string]int32{
	"PENDING": 0,
	"SUCCESS": 1,
	"ERROR":   2,
}

func (x RemoteMulticastDeploymentDeviceState) String() string {
	return proto.EnumName(RemoteMulticastDeploymentDeviceState_name, int32(x))
}

func (RemoteMulticastDeploymentDeviceState) EnumDescriptor() ([]byte, []int) {
...
type RemoteMulticastGroup struct {
	...
	// Multicast Group ID.
	MulticastGroupId string `protobuf:"bytes,3,opt,name=multicast_group_id,json=multicastGroupId,proto3" json:"multicast_group_id,omitempty"`
	// Service-profile ID.
	...
	GroupType RemoteMulticastGroupType `protobuf:"varint,6,opt,name=group_type,json=groupType,proto3,enum=api.RemoteMulticastGroupType" json:"group_type,omitempty"`
	// Data-rate.
	Dr uint32 `protobuf:"varint,7,opt,name=dr,proto3" json:"dr,omitempty"`
	// Frequency (Hz).
	...
	PingSlotPeriod uint32 `protobuf:"varint,9,opt,name=ping_slot_period,json=pingSlotPeriod,proto3" json:"ping_slot_period,omitempty"`
	...
	// device. The Remote Multicast deployment engine will wait at least for the given time
	...
	// Next step after.
	// This value will be automatically set on create.
	NextStepAfter        *timestamp.Timestamp `protobuf:"bytes,12,opt,name=next_step_after,json=nextStepAfter,proto3" json:"next_step_after,omitempty"`
...
func (m *RemoteMulticastGroup) GetMulticastGroupId() string {
	if m != nil {
...
func (m *RemoteMulticastGroup) GetGroupType() RemoteMulticastGroupType {
	if m != nil {
		return m.GroupType
	}
	return RemoteMulticastGroupType_CLASS_C
}
...
type RemoteMulticastDeploymentDevice struct {
	...
	MulticastGroupName string `protobuf:"bytes,5,opt,name=multicast_group_name,json=multicastGroupName,proto3" json:"multicast_group_name,omitempty"`
	...
	// This value will be automatically set on create.
	State RemoteMulticastDeploymentDeviceState `protobuf:"varint,8,opt,name=state,proto3,enum=api.RemoteMulticastDeploymentDeviceState" json:"state,omitempty"`
...
func (m *RemoteMulticastDeploymentDevice) GetMulticastGroupId() string {
	if m != nil {
		return m.MulticastGroupId
	}
	return ""
...
func (m *RemoteMulticastDeploymentDevice) GetState() RemoteMulticastDeploymentDeviceState {
	if m != nil {
		return m.State
	}
	return RemoteMulticastDeploymentDeviceState_PENDING
}
...
type GetRemoteMulticastGroupResponse struct {
	...
	McAddr string `protobuf:"bytes,4,opt,name=mc_addr,json=mcAddr,proto3" json:"mc_addr,omitempty"`
	// Multicast network session key (HEX encoded AES128 key).
	McNwkSKey string `protobuf:"bytes,5,opt,name=mc_nwk_s_key,json=mcNwkSKey,proto3" json:"mc_nwk_s_key,omitempty"`
	// Multicast application session key (HEX encoded AES128 key).
	McAppSKey string `protobuf:"bytes,6,opt,name=mc_app_s_key,json=mcAppSKey,proto3" json:"mc_app_s_key,omitempty"`
	// Frame-counter.
...
func (m *GetRemoteMulticastGroupResponse) GetMcAddr() string {
	if m != nil {
		return m.McAddr
	}
	return ""
...
func (m *GetRemoteMulticastGroupResponse) GetMcNwkSKey() string {
	if m != nil {
		return m.McNwkSKey
	}
	return ""
...
func (m *GetRemoteMulticastGroupResponse) GetMcAppSKey() string {
	if m != nil {
		return m.McAppSKey
	}
	return ""
...
func (m *GetRemoteMulticastGroupResponse) GetFCnt() uint32 {
	if m != nil {
		return m.FCnt
	}
	return 0
...
func init() {
	proto.RegisterEnum("api.RemoteMulticastGroupType", RemoteMulticastGroupType_name, RemoteMulticastGroupType_value)
	proto.RegisterEnum("api.RemoteMulticastDeploymentDeviceState", RemoteMulticastDeploymentDeviceState_name, RemoteMulticastDeploymentDeviceState_value)
...
var fileDescriptor_a7745b072e8a8e4e = []byte{
	...
	,
}
