...
_GATEWAYSTATSEVENT = _descriptor.Descriptor(
  ...
  nested_types=[_GATEWAYSTATSEVENT_METADATAENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
