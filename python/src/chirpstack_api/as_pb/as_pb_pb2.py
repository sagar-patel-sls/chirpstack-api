...
_HANDLECONNSTATEREQUEST = _descriptor.Descriptor(
  name='HandleConnStateRequest',
  full_name='as.HandleConnStateRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='gateway_id', full_name='as.HandleConnStateRequest.gateway_id', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='state', full_name='as.HandleConnStateRequest.state', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='stats_id', full_name='as.HandleConnStateRequest.stats_id', index=2,
      number=3, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HANDLECONNSTATEREQUEST.fields_by_name['state'].enum_type = chirpstack__api_dot_gw_dot_gw__pb2._STATE
...
DESCRIPTOR.message_types_by_name['HandleConnStateRequest'] = _HANDLECONNSTATEREQUEST
...
_APPLICATIONSERVERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='HandleGatewayConnStats',
    full_name='as.ApplicationServerService.HandleGatewayConnStats',
    index=9,
    containing_service=None,
    input_type=_HANDLECONNSTATEREQUEST,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
