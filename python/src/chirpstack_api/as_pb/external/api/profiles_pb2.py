...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n!io.chirpstack.api.as.external.apiB\rProfilesProtoP\001Z?github.com/sagar-patel-sls/chirpstack-api/go/v3/as/external/api'
