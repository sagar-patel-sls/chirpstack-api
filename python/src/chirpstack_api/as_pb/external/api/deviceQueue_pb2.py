...
_LISTDEVICEQUEUEITEMSREQUEST = DESCRIPTOR.message_types_by_name['ListDeviceQueueItemsRequest']
_LISTDEVICEQUEUEITEMSRESPONSE = DESCRIPTOR.message_types_by_name['ListDeviceQueueItemsResponse']
...
_DEVICEQUEUESERVICE = DESCRIPTOR.services_by_name['DeviceQueueService']
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'\n!io.chirpstack.api.as.external.apiB\020DeviceQueueProtoP\001Z?github.com/sagar-patel-sls/chirpstack-api/go/v3/as/external/api'
