...
_sym_db.RegisterEnumDescriptor(_FRAGMENTATIONDEPLOYMENTGROUPTYPE)

FragmentationDeploymentGroupType = enum_type_wrapper.EnumTypeWrapper(_FRAGMENTATIONDEPLOYMENTGROUPTYPE)
CLASS_C = 0
CLASS_B = 1
...
_FRAGMENTATIONDEPLOYMENT.fields_by_name['group_type'].enum_type = _FRAGMENTATIONDEPLOYMENTGROUPTYPE
...
_GETFRAGMENTATIONDEPLOYMENT.fields_by_name['group_type'].enum_type = _FRAGMENTATIONDEPLOYMENTGROUPTYPE
...
DESCRIPTOR.enum_types_by_name['FragmentationDeploymentGroupType'] = _FRAGMENTATIONDEPLOYMENTGROUPTYPE
