...
goog.exportSymbol('proto.as.HandleMTypeRequest', null, global);
...
/**
 * optional common.MType m_type = 12;
 * @return {!proto.common.MType}
 */
proto.as.HandleUplinkDataRequest.prototype.getMType = function() {
  return /** @type {!proto.common.MType} */ (jspb.Message.getFieldProto3(this, 12, 0));
};


/** @param {!proto.common.MType} value  */
proto.as.HandleUplinkDataRequest.prototype.setMType = function(value) {
...
/**
 * map<string, uint32> mtype_count = 15;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,number>}
 */
proto.as.HandleGatewayStatsRequest.prototype.getMtypeCountMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,number>} */ (
 ...
 * @constructor
 */
proto.as.HandleMTypeRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.as.HandleMTypeRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.as.HandleMTypeRequest.displayName = 'proto.as.HandleMTypeRequest';
}
 ...
 * @return {!Object}
 */
proto.as.HandleMTypeRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.as.HandleMTypeRequest.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.as.HandleMTypeRequest} msg The msg instance to transform.
 * @return {!Object}
 */
proto.as.HandleMTypeRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    devEui: msg.getDevEui_asB64(),
    mType: msg.getMType()
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.as.HandleMTypeRequest}
 */
proto.as.HandleMTypeRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.as.HandleMTypeRequest;
  return proto.as.HandleMTypeRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.as.HandleMTypeRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.as.HandleMTypeRequest}
 */
proto.as.HandleMTypeRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.as.HandleMTypeRequest} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.as.HandleMTypeRequest.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.as.HandleMTypeRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.as.HandleMTypeRequest.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getDevEui_asU8();
  if (f.length > 0) {
    writer.writeBytes(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.as.HandleMTypeRequest} The clone.
 */
proto.as.HandleMTypeRequest.prototype.cloneMessage = function() {
  return /** @type {!proto.as.HandleMTypeRequest} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.as.HandleMTypeRequest.prototype.getDevEui = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldProto3(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.as.HandleMTypeRequest.prototype.getDevEui_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getDevEui()));
};
 ...
 * @return {!Uint8Array}
 */
proto.as.HandleMTypeRequest.prototype.getDevEui_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getDevEui()));
};
...
/** @param {!(string|Uint8Array)} value  */
proto.as.HandleMTypeRequest.prototype.setDevEui = function(value) {
  jspb.Message.setField(this, 1, value);
};


/**
 * optional common.MType m_type = 2;
 * @return {!proto.common.MType}
 */
proto.as.HandleMTypeRequest.prototype.getMType = function() {
  return /** @type {!proto.common.MType} */ (jspb.Message.getFieldProto3(this, 2, 0));
};


/** @param {!proto.common.MType} value  */
proto.as.HandleMTypeRequest.prototype.setMType = function(value) {
  jspb.Message.setField(this, 2, value);
};
