...
export interface IApplicationServiceServer extends grpc.UntypedServiceImplementation {
  ...
  createLoccartoIntegration: grpc.handleUnaryCall<as_external_api_application_pb.CreateLoccartoIntegrationRequest, google_protobuf_empty_pb.Empty>;
  getLoccartoIntegration: grpc.handleUnaryCall<as_external_api_application_pb.GetLoccartoIntegrationRequest, as_external_api_application_pb.GetLoccartoIntegrationResponse>;
  updateLoccartoIntegration: grpc.handleUnaryCall<as_external_api_application_pb.UpdateLoccartoIntegrationRequest, google_protobuf_empty_pb.Empty>;
  deleteLoccartoIntegration: grpc.handleUnaryCall<as_external_api_application_pb.DeleteLoccartoIntegrationRequest, google_protobuf_empty_pb.Empty>;
