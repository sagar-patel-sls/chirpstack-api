...
export interface IRemoteMulticastGroupServiceServer extends grpc.UntypedServiceImplementation {
  create: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.CreateRemoteMulticastGroupRequest, as_external_api_remoteMulticastGroup_pb.CreateRemoteMulticastGroupResponse>;
  get: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.GetRemoteMulticastGroupRequest, as_external_api_remoteMulticastGroup_pb.GetRemoteMulticastGroupResponse>;
  update: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.UpdateRemoteMulticastGroupRequest, google_protobuf_empty_pb.Empty>;
  delete: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.DeleteRemoteMulticastGroupRequest, google_protobuf_empty_pb.Empty>;
  list: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.ListRemoteMulticastGroupRequest, as_external_api_remoteMulticastGroup_pb.ListRemoteMulticastGroupResponse>;
  addDevice: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.AddDeviceToRemoteMulticastGroupRequest, google_protobuf_empty_pb.Empty>;
  resetDevice: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.ResetRemoteMulticastDeviceRequest, google_protobuf_empty_pb.Empty>;
  removeDevice: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.RemoveDeviceFromRemoteMulticastGroupRequest, google_protobuf_empty_pb.Empty>;
  listDevicesForRemoteMulticast: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.ListRemoteMulticastDeviceRequest, as_external_api_remoteMulticastGroup_pb.ListRemoteMulticastDeviceResponse>;
  getDevicesList: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.ListRemoteMulticastDeviceRequest, as_external_api_remoteMulticastGroup_pb.ListRemoteMulticastDevicesResponse>;
  getDeploymentDevice: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.GetRemoteMulticastDeploymentDeviceRequest, as_external_api_remoteMulticastGroup_pb.GetRemoteMulticastDeploymentDeviceResponse>;
  enqueue: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.EnqueueRemoteMulticastQueueItemRequest, as_external_api_remoteMulticastGroup_pb.EnqueueRemoteMulticastQueueItemResponse>;
  flushQueue: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.FlushRemoteMulticastGroupQueueItemsRequest, google_protobuf_empty_pb.Empty>;
  listQueue: grpc.handleUnaryCall<as_external_api_remoteMulticastGroup_pb.ListRemoteMulticastGroupQueueItemsRequest, as_external_api_remoteMulticastGroup_pb.ListRemoteMulticastGroupQueueItemsResponse>;
}
